...
public class Audi extends Masina {
    ...
    public Audi(String caroserie, Integer roti, Integer usi,
                String sasiu, Double motorizare,
                String transmisie, String combustibil,
                String model, List<String> dotari,Double pret) {
        super(caroserie, roti, usi, sasiu, motorizare,
